...
class Helix3FeatureContact {
	...
	public function renderFeature() {
		...
		if($this->helix3->getParam('enable_contactinfo')) {
			...
			if($this->helix3->getParam('address')) $output .= '<li class="sp-contact-address"><i class="fa fa-map-marker" aria-hidden="true"></i> <p class="address-text"> ' . $this->helix3->getParam('address') . '</p></li>';
