...
if ($logo_image = $params->get('error_logo')) {
    ...
    $logo 		= $this->baseurl . '/templates/' . $this->template . '/images/presets/preset1/logo_error.jpg';
    $path 		= JPATH_ROOT . '/templates/' . $this->template . '/images/presets/preset1/logo_error.jpg';
    $ratlogo 	= $this->baseurl . '/templates/' . $this->template . '/images/presets/preset1/logo_error.jpg';
}
